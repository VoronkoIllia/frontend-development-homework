...
function isFormValid() {
  ...
  if (form.elements["username"].value.trim() === "") {
    ...
    form.elements["username"].ariaInvalid = "true";
    form.elements["username"].ariaErrormessage = "Це поле є обов'язковим.";
    ...
    form.elements["email"].ariaInvalid = "true";
    form.elements["email"].ariaErrormessage =
      "Будь ласка, введіть дійсну електронну адресу.";
    ...
    form.elements["password"].ariaInvalid = "true";
    form.elements["password"].ariaErrormessage =
      "Пароль повинен містити щонайменше 8 символів.";
  } else if (
    ...
    form.elements["confirm-password"].ariaInvalid = "true";
    form.elements["confirm-password"].ariaErrormessage =
      "Паролі не співпадають.";
    ...
    form.elements["birthdate"].ariaInvalid = "true";
    form.elements["birthdate"].ariaErrormessage =
      "Будь ласка, вкажіть дату народження.";
  } else {
    isValid = true;
  }
